...
/**
 * Servlet implementation class DBRecords
 */
@WebServlet(
		urlPatterns = { "/record" }, 
		initParams = { 
				...
				@WebInitParam(name = "password", value = "aman@123")
		})
public class DBRecordsApp extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("RequestProcessing :: DBRecordsApp.doGet()");
		...
		try {
			...
			if(resultSet != null) {
				...
				out.println("<h1 style='color:red; text-align:'center'>EMPLOYEE INFROMATION</h1>");
				out.println("<table border='1' align='center'>");
				out.println("<tr><th>EID</th><th>ENAME</th><th>ESAL</th><th>EADDRESS</th></tr>");
