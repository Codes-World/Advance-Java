...
@Entity
@NamedQuery(name = "HQL_TRANSFER_POLICIES", query = "INSERT INTO in.codesworld.aman.bean.PremiumInsurancePolicy(policyId, policyName, policyType, company, tenure) SELECT i.policyId,i.policyName,i.policyType,i.company,i.tenure FROM in.codesworld.aman.bean.InsurancePolicy AS i WHERE i.tenure>=:min")
