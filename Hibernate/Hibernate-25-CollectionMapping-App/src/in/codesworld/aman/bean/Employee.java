...
public class Employee implements Serializable {
	...
	public Employee(String ename, String eaddress, List<String> friends, Set<Long> phoneNumbers, Map<String, Long> bankAccounts) {
		this.ename = ename;
	...
	public String toString() {
		return "Employee [eid=" + eid + ", ename=" + ename + ", eaddress=" + eaddress + ", friends=" + friends + ", phoneNumbers=" + phoneNumbers + ", bankAccounts=" + bankAccounts + "]";
	}
