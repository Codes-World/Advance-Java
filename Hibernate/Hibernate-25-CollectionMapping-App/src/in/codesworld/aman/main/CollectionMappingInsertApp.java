...
public class CollectionMappingInsertApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Employee employee = new Employee("sachin", "MI", List.of("saurav", "dravid", "sehwagh"), Set.of(999888777L, 666555444L, 777888555L), Map.of("SBI",55544466L, "HDFC",6575657L,"ICICI",8877799L));
